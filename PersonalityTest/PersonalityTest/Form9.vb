Public Class frmQuestionsSix
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Exit Sub
        End If
        frmQuestionsSeven.ex = ex
        frmQuestionsSeven.i = i
        frmQuestionsSeven.s = s
        frmQuestionsSeven.n = n
        frmQuestionsSeven.t = t
        frmQuestionsSeven.f = f
        frmQuestionsSeven.j = j
        frmQuestionsSeven.p = p
        Me.Close()
        frmQuestionsSeven.Show()
