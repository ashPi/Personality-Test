Public Class frmQuestionsFour
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Exit Sub
        End If
        frmQuestionsFive.ex = ex
        frmQuestionsFive.i = i
        frmQuestionsFive.s = s
        frmQuestionsFive.n = n
        frmQuestionsFive.t = t
        frmQuestionsFive.f = f
        frmQuestionsFive.j = j
        frmQuestionsFive.p = p
        Me.Close()
        frmQuestionsFive.Show()
