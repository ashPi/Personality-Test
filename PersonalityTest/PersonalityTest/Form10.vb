Public Class frmQuestionsSeven
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Exit Sub
        End If
        frmQuestionsEight.ex = ex
        frmQuestionsEight.i = i
        frmQuestionsEight.s = s
        frmQuestionsEight.n = n
        frmQuestionsEight.t = t
        frmQuestionsEight.f = f
        frmQuestionsEight.j = j
        frmQuestionsEight.p = p
        Me.Close()
        frmQuestionsEight.Show()

    End Sub


    Private Sub frmQuestionsSeven_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
